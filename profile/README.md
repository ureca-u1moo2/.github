  ...
  <tr>
    <td valign="top" width="50%">
      ...
      <table>
        ...
        <tr><td>이메일/비밀번호 찾기</td><td>개인정보 기반 이메일 찾기<br>이메일로 재설정 링크 전송</td></tr>
        <tr><td>보안</td><td>-</td></tr>
        <tr><td>마이페이지</td><td>가입 요금제, 사용량, 회원 정보 조회</td></tr>
        <tr><td>요금제 검색/비교</td><td>목록(인기순/데이터/가격순), 상세/비교 페이지</td></tr>
        <tr><td>AI</td><td>요금제 리뷰 요약</td></tr>
      </table>
    ...
    <td valign="top" width="50%">
      ...
      <table>
        <tr><th>기능</th><th>설명</th></tr>
        <tr><td>회원가입/로그인</td><td>JWT 인증 방식<br>RTR 방식</td></tr>
        <tr><td>대시보드</td><td>챗봇 로그 기반 시각화<br>의도/응답시간 지표</td></tr>
        <tr><td>사용자 분석</td><td>회선 기반 사용자 행동 분석</td></tr>
        <tr><td>요금제 분석</td><td>요금제 검색/정렬 필터 및 데이터 기반 분석</td></tr>
