...
<table>
  <tr>
    <td valign="top" width="50%">
      ...
      <ul>
        <li><b>회원가입/로그인</b>: JWT 인증, RTR 방식</li>
        <li><b>이메일/비밀번호 찾기</b>: 이메일 찾기, 재설정 링크 전송</li>
        <li><b>보안</b>: - </li>
        <li><b>마이페이지</b>: 요금제/사용량/회원 정보 조회</li>
        <li><b>요금제 검색/비교</b>: 목록(인기/데이터/가격), 상세/비교</li>
        <li><b>AI</b>: 요금제 리뷰 요약</li>
      </ul>
    ...
    <td valign="top" width="50%">
      ...
      <ul>
        <li><b>회원가입/로그인</b>: JWT 인증, RTR 방식</li>
        <li><b>대시보드</b>: 챗봇 로그 시각화, 의도/응답시간 지표</li>
        <li><b>사용자 분석</b>: 회선 기반 사용자 분석</li>
        <li><b>요금제 분석</b>: 요금제 정렬/검색/분석</li>
        <li><b>금칙어 관리</b>: 금칙어 등록/조회/삭제</li>
      </ul>
